...
### Scenarios for Profile 0 X D
Scenarios0D <- BSEIR::get.sim.scenarios(b0.vec = 0,
                                        v.vec = 0,
                                        d0.vec = 0,
...
write.csv(Scenarios0D, file = paste0(path0, "/Scenarios0D", ".csv"), row.names = FALSE)

Scenarios0D_params.mat <- BSEIR:::scenario2params (Scenarios0D, sep = "+",
                                                  name.cols = TRUE)

dim(Scenarios0D_params.mat)
head(Scenarios0D_params.mat[, 1:13], 20)
