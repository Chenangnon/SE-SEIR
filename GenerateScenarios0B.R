...
### Scenarios for Profile 0 X B
Scenarios0B <- BSEIR::get.sim.scenarios(b0.vec = 0,
                                        d0.vec = 0,
                                        e.vec = 0,
...
write.csv(Scenarios0B, file = paste0(path0, "/Scenarios0B", ".csv"), row.names = FALSE)

Scenarios0B_params.mat <- BSEIR:::scenario2params (Scenarios0B, sep = "+",
                                                  name.cols = TRUE)

dim(Scenarios0B_params.mat)
head(Scenarios0B_params.mat[, 1:13], 20)
